...
public class SkillSlot : Slot
{
    public override void SetItem(int i)
    {
        ...
        SkillManager.Instance.skillExplanation[3].text = SkillManager.Instance.skillSo.skillData[i].skillExplanation + "  " + "µ¥¹ÌÁö : " + SkillManager.Instance.skillSo.skillData[i].damage.ToString();
